                ...
                <ul class="navba">
                    ...
                    <li class="nav-item pt-3">
                        <div class="d-flex align-items-center">
                            ...
                            <a class="nav-link text-white ms-2" href="{{ route('admin.posts.index') }}">{{ __('Post') }}</a>
                        </div>
                    </li>
                    <li class="nav-item d-flex align-items-center pt-3">
                        <div class="icon-container d-flex justify-content-center">
                        ...
                        <a class="nav-link text-white ms-2" href="{{ route('admin.categories.index') }}">{{ __('Category') }}</a>
                    </li>
                    <li class="nav-item d-flex align-items-center pt-3"> 
                        <div class="icon-container d-flex justify-content-center">
